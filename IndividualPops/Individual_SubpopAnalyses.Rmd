...
xprsn.mtx <- t(as.data.frame(as.matrix(seurat.object@assays$RNA@data))[rownames(as.data.frame(as.matrix(seurat.object@assays$RNA@data))) %in% probe.list, ])
biomark.export <- merge(xprsn.mtx, seurat.object@meta.data["RNA_snn_res.1"], by = 0)
...
xprsn.mtx <- t(as.data.frame(as.matrix(seurat.object@assays$RNA@scale.data))[rownames(as.data.frame(as.matrix(seurat.object@assays$RNA@scale.data))) %in% probe.list, ])
biomark.export <- merge(xprsn.mtx, seurat.object@meta.data["RNA_snn_res.1"], by = 0)
